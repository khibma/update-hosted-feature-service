# update_directory.py - update entire directory of hosted feature services by replacing the .SD file
...
#Directory of .ini files - Change to your directory
#Create one .ini file per feature service
directory = r"G:\GIS_Projects\python_arcpy_scripts\FmGis.Lib.ArcPy\updateFS"
...
for file in os.listdir(directory):
    if file.endswith(".ini") and __name__ == "__main__":
		
		print("Now exporting " + file)
		setfile = os.path.join(directory, file)
...
print("Congratulations!  All feature services in " + directory + " have been updated.")